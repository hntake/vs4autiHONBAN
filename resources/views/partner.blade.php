...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>パートナープログラム 視覚支援ツールvs4Auti </title>
                        ...
                        <div class="partner_logo">
                            ...
                            パートナープログラム</h2>
                                ...
                                <div class="sales_discription">
                                    VS4Autiパートナープログラムは、福祉や医療機関にVS4Autiを普及していただくパートナーを対象とした「ディストリビューターパートナープログラム」と、広告を掲載をしたいパートナーを対象とした『サポートプログラム』の２つのプログラムで構成されます。<br>
                                    VS4Autiがより多くの人たちに活用され、障がいによる支障を一つでも減らせる、そんな未来を作っていきます。
                                </div>
                        </div>
                        <div class="middle-partner">
                        <a name="paid">
                            <div class="partner_logo">
                                <h2>VS4Auti <br>ディストリビュータープログラム</h2>
                            </div>
                            <div class="sales">
                                ...
                                <div class="sales_discription">
                                    VS4Autiの作成による利用自体は完全無料ですが、ご自身の画像を保存する有償プランがあります。この有償プランの普及をして頂けるディストリビューターパートナーを募集しています。<br>
                                    詳しくはこちらからお問い合わせください。
                        ...
                        <a name="monitor">
                            ...
                            <div class="sales">
                                ...
                                <div class="sponsor_discription">
                                    VS4Autiは視覚支援ツールです。広告は、視覚支援の妨げになりますので、限られたページでのみの広告となりますが、運営するためのサポートをして下さる広告スポンサーを募集しています。<br>
                                    詳しくはこちらからお問い合わせください。
                                    <div  class="admin_button" ><a href="{{ route('contact.index') }}" style="background-color:none; color:#7791DE;">お問い合わせページへ</a></div>
                                </div>
                            </div>
