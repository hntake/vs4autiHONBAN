                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <td>{{ $schedule->id }}</td><br>
                                ...
                                <img src="{{ asset('storage/' . $schedule->image0) }}" alt="image" style="width: 160px; height: auto;"></td>
                                <td><p><div class="arrow">&#9660;</div></p></td>
                                <td><a href="{{ asset('storage/' . $schedule->image1) }}" target="_blank"></a>
                                <img src="{{ asset('storage/' . $schedule->image1) }}" alt="image" style="width: 160px; height: auto;"></td>
                                @if(isset($schedule->image2))
                                <td><p><div class="arrow">&#9660;</div></p></td>
                                <td><a href="{{ asset('storage/' . $schedule->image2) }}" target="_blank"></a>
                                <img src="{{ asset('storage/' . $schedule->image2) }}" alt="image" style="width: 160px; height: auto;"></td>
                                @endif
                                @if(isset($schedule->image3))
                                <td><p><div class="arrow">&#9660;</div></p></td>
                                <td><a href="{{ asset('storage/' . $schedule->image3) }}" target="_blank"></a>
                                <img src="{{ asset('storage/' . $schedule->image3) }}" alt="image" style="width: 160px; height: auto;"></td>
                                @endif
                                @if(isset($schedule->image4))
                                <td><p><div class="arrow">&#9660;</div></p></td>
                                <td><a href="{{ asset('storage/' . $schedule->image4) }}" target="_blank"></a>
                                <img src="{{ asset('storage/' . $schedule->image4) }}" alt="image" style="width: 160px; height: auto;"></td>
                                @endif
                        </tr>
