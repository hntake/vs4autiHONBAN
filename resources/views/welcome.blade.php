...
<head>
    ...
    <meta name="description" content="ボランティア団体IT2Uによるサイト。自閉症、知的障害、発達障害を持つ人の中には聴覚入力よりも視覚的サポート(絵カード)を利用することで、より良く理解できる傾向がある人がいます。VS4は視覚支援ツール（絵カード）をスマホで作れるアプリです。迷子対策のお守りバッジも販売中" >
