...
<div class="card_container py-3">
    ...
    <div id="bank-info" style="display:none;">
        <form action="{{route('bank_submit_un',['id'=> $design->id])}}" method="post" id="bank-form">
        @csrf
    ...
    <div id="prepaid-use-form" style="display:none;">
        <h4>あなたの残高:{{$buyer->balance}}円</h4>
            <form action="{{route('prepaid_submit',['id'=> $design->id])}}" method="post" id="balance-form">
            @csrf
    ...
    <div id="prepaid-add-form" style="display:none;">
        <h4>あなたの残高:{{$buyer->balance}}円</h4>
        <form action="{{route('prepaid_add')}}" method="post" id="add-form">
        @csrf
...
<script>
    function showSection(selectedId) {
        const sections = ['credit-card-form', 'bank-info', 'prepaid-use-form', 'prepaid-add-form'];
