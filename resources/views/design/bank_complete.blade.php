...
<header id="header">
    ...
    <div class="card_container py-3">
        <div class="explain">
            ...
            <h4><span style="color:lightblue">ダウンロード作品</span>：支払い確認後、ダウンロードページが登録メールアドレスへメールされます。</h4>
            <h4><span style="color:lightblue">現物販売作品</span>：支払い確認後、登録メールアドレスへ受領メール、発送メールが送られます。２週間以内に発送されます。</h4>
