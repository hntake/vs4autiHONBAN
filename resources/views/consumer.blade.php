            ...
            <div class="pt-4 bg-gray-100">
                <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                    ...
                    <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                        ...
                        <h2>お問い合わせ</h2>
                        <p>こちらまで→
                        <button class="button"><a href="{{ route('contact.index') }}" >Contact us</a></button></p>

                        <div class="back">
                            <button class="btn btn-primary" id="card-button"><a href="{{ url('/') }}">VS4Autiトップページに戻る</a></button>
                    </div>
                    </div>
                </div>
            </div>
